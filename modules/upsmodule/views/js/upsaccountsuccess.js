 ...
 */
 ...
 $(document).ready(function(){
    ...
    $(window).load(function () {
        ...
        if ($("#checkErrors").text() == 1)
        {
            document.getElementById("Userpwdform").style.display = "block";
    ...
    $('#rate07').change(function(){
        if ($(this).is(':checked')){
            $(".rate07_show").removeClass("upshidden");
            $(".rate08_show").addClass("upshidden");
            $(".rate10_show").addClass("upshidden");
    ...
    $('#rate10').change(function(){
        if ($(this).is(':checked')){
            $(".rate10_show").removeClass("upshidden");
            $(".rate08_show").addClass("upshidden");
            $(".rate07_show").addClass("upshidden");
            $('#rate08').val(3);
        }
...
function addUPSUsernameandPwd(){
    if(document.getElementById("Userpwdform").style.display == 'block'){
        document.getElementById("Userpwdform").style.display = 'none';
        document.getElementById("iclass").classList.add('icon-circle-arrow-down');
        document.getElementById("iclass").classList.remove('icon-circle-arrow-up');
        return false;
    }
    document.getElementById("Userpwdform").style.display = "block";
    document.getElementById("iclass").classList.add('icon-circle-arrow-up');
    document.getElementById("iclass").classList.remove('icon-circle-arrow-down');
