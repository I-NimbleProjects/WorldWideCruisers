        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"LG PuriCare Water","display":"3","animation":"6"},"2":{"title":"Air Purifier","display":"0","animation":"7"},"3":{"title":"High Performance","display":"1","animation":"8"},"4":{"title":"Smart Healthy Living For Everyone. Will Only Accompany You Quietly","display":"4","animation":"9"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"Oled Touch Display","display":"3","animation":"8"},"2":{"title":"Mi Air Purifier","display":"0","animation":"9"},"3":{"title":"High Performance","display":"1","animation":"7"},"4":{"title":"Smart Healthy Living For Everyone. Will Only Accompany You Quietly","display":"4","animation":"6"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
