    ...
    <script>
        ...
        function springXBSsaveDimensionsTemporary(formNode, url) {
            ...
            $.get(
                ...
                '&ddp=' + formNode.elements.ddp.value,
                function () {
          ...
          <span class="btn-group">
            <a href="{$label_link|escape:'htmlall':'UTF-8'}"
               ...
               data-toggle="tooltip" title="{$label_link_title|escape:'htmlall':'UTF-8'}">
                {if !$label_exists}
                    <svg height="15pt" viewBox="0 0 479.89999 479" width="15pt">
                        ...
                        <path d="m166.433594 302.582031 22.625-22.625 124.453125 124.449219-22.628907 22.628906zm0 0"/>
                        <path d="m223.003906 246.011719 22.625-22.625 124.449219 124.453125-22.628906 22.628906zm0 0"/>
                        <path d="m256.933594 212.074219 22.628906-22.625 124.453125 124.445312-22.625 22.628907zm0 0"/>
                        <path d="m290.886719 178.132812 11.3125-11.3125 124.449219 124.453126-11.316407 11.316406zm0 0"/>
                        <path d="m200.367188 268.648438 11.316406-11.316407 124.453125 124.445313-11.3125 11.316406zm0 0"/>
                    </svg>
                {else}
        ...
        <div class="">
            <div class="well">
                ...
                {if $parcel_dimensions}
                    <br>
                    <p>{l s='Ordered' mod='springxbs'} <strong>{l s='Parcel Dimensions' mod='springxbs'}</strong></p>
                    <table>
                        <tr>
                            <td>
                                <span>{l s='width' mod='springxbs'} <br>{if $parcel_dimensions['width']}{$parcel_dimensions['width']|escape:'htmlall':'UTF-8'} cm{else}-{/if}</span>
                            </td>
                            <td>
                                <span>{l s='height' mod='springxbs'} <br>{if $parcel_dimensions['height']}{$parcel_dimensions['height']|escape:'htmlall':'UTF-8'} cm{else}-{/if}</span>
                            </td>
                            <td>
                                <span>{l s='depth' mod='springxbs'} <br>{if $parcel_dimensions['depth']}{$parcel_dimensions['depth']|escape:'htmlall':'UTF-8'} cm{else}-{/if}</span>
                            </td>
                            <td>
                                <span>{l s='weight' mod='springxbs'} <br>{if $parcel_dimensions['weight']}{$parcel_dimensions['weight']|escape:'htmlall':'UTF-8'} kg{else}-{/if}</span>
                            </td>
                        </tr>
                    </table>
                {/if}
                {if $parcel_dimensions['ddp'] === 'DDP'}
                    <div style="margin-top: 15px;">
                        <p>
                            <strong>{l s='Total Tax' mod='springxbs'}:</strong> {$totals['tax']|floatval} {$totals['currency']|escape:'htmlall':'UTF-8'}
                        </p>
                        <p>
                            <strong>{l s='Total Duty' mod='springxbs'}:</strong> {$totals['duty']|floatval} {$totals['currency']|escape:'htmlall':'UTF-8'}
                        </p>
                    </div>
                {/if}
            </div>
            {if !$label_exists && $can_get_label}
                <div class="">
                    <div class="">{l s='Get label with' mod='springxbs'} <strong>{l s='Parcel Dimensions' mod='springxbs'}</strong> {l s='set below' mod='springxbs'}</div>
                    <table class="dim-table">
                        <tr>
                            <td class="">
                                <label for="Parcel_dimensions_width_{$id|intval}">{l s='width' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                            ...
                            <td class="">
                                <label for="Parcel_dimensions_height_{$id|intval}">{l s='height' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                            ...
                            <td class="">
                                <label for="Parcel_dimensions_length_{$id|intval}">{l s='depth' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                            ...
                            <td class="">
                                <label for="Parcel_dimensions_weight_{$id|intval}">{l s='weight' mod='springxbs'}, {l s='kg' mod='springxbs'}</label>
                            ...
                            <td rowspan="2" style="vertical-align: bottom !important;">
                        ...
                        <tr>
                            <td>{l s='Customs options' mod='springxbs'}:</td>
                            <td>
                                <label style="display: block">
                                    <input type="radio"
                                           name="ddp"
                                           value="DDP"
                                           {if $parcel_prefilled_dimensions['ddp'] === 'DDP'}checked="checked"{/if}>
                                    <span>&nbsp;&nbsp;{l s='DDP' mod='springxbs'}</span>
                                </label>
                            </td>
                            <td>
                                <label style="display: block">
                                    <input type="radio"
                                           name="ddp"
                                           value="DDU"
                                           {if $parcel_prefilled_dimensions['ddp'] === 'DDU'}checked="checked"{/if}>
                                    <span>&nbsp;&nbsp;{l s='DDU' mod='springxbs'}</span>
                                </label>
                            </td>
                            <td></td>
                        </tr>
        ...
        $("#popovers_{$id|intval}").on('shown.bs.popover', function () {
            if ({$prefix|escape:'htmlall':'UTF-8'}dimensions_entered_{$id|intval}) {
                var interv = setInterval(function () {
                    ...
                    formEls.ddp.value = {$prefix|escape:'htmlall':'UTF-8'}dimensions_entered_{$id|intval}.ddp;
                }, 50);
            }
