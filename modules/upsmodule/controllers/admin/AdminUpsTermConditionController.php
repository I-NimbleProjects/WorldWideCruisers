...
class AdminUpsTermConditionController extends CommonController
{
    ...
    private function getTermAndCondition()
    {
        ...
        //     if (in_array($this->module->lang, array('de', 'it', 'nl', 'be')) && Configuration::get('UPS_COUNTRY_SELECTED') != 'IT') {
        //         $txt = iconv(mb_detect_encoding($txt, mb_detect_order(), true), "ISO-8859-1//IGNORE", $txt);
        //         return iconv(mb_detect_encoding($txt, mb_detect_order(), true), "UTF-8//IGNORE", $txt);
        //     } elseif ($this->module->lang == 'fr' && Configuration::get('UPS_COUNTRY_SELECTED') != 'FR') {
                
        //         return iconv(mb_detect_encoding($txt, mb_detect_order(), true), "ISO-8859-1", $txt); // Except fr-FR //old code
        //     }
        // }
