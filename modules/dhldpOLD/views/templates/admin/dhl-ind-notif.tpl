...
<div class="alert alert-info">{l s='Would you like to individualise the DHL parcel notification? You can now display your logo and the desired shop name in the parcel notification. Use the following form to do so' mod='dhldp'}:
