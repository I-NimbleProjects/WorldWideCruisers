    ...
    <div class="col-lg-12">
        ...
        <div class="panel">
            ...
            <div class="form-wrapper">
                ...
                <a href="javascript:void(0)" onclick="addUPSUsernameandPwd()" >{$texts.txtAccAddUsernameandPwd|escape:'htmlall':'UTF-8'} <i id="iclass" class="icon-circle-arrow-down"></i></a><br/>
                <div class="temp" id="Userpwdform" style="display: none">
                    <div class="form-group">
                    <br/>
                        <label class="control-label col-lg-3">
                            <span class="label-tooltip" data-toggle="tooltip" data-html="true" data-original-title="{$texts.txtTTUPSUsername|escape:'htmlall':'UTF-8'}" data-placement="top">{$texts.txtUPSUsername|escape:'htmlall':'UTF-8'}:<sup class ="star">*</sup></span>
                        </label>
                        <div class="col-lg-9">
                            <input type="text" name="UPSUsername" id="UPSUsername" value="{$UPSUsername|escape:'htmlall':'UTF-8'}" maxlength="50" class="form-control ups-form-control fixed-width-xxl">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" data-original-title="{$texts.txtTTUPSPassword|escape:'htmlall':'UTF-8'}" data-placement="top">{$texts.txtUPSPassword|escape:'htmlall':'UTF-8'}:<sup class="star">*</sup></span>
                    </label>
                    <div class="col-lg-9">
                        <input type="text" name="UPSPassword" id="UPSPassword" value="{$UPSPassword|escape:'htmlall':'UTF-8'}" maxlength="35" class="form-control ups-form-control fixed-width-xxl">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <span><button id="SubmitUsernameandPwd" class="btn" name ="SubmitUsernameandPwd" style="border-radius:4px; background-color:#FDD204; color:#370505">Procced to change</button></span>
                </div>
                <br/>
