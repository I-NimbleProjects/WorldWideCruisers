...
<div id="springxbs-export-panel">
                            ...
                            <div class="col-lg-8">
                                {if !$is_shipment}
                                    <div class="dimensions-container">
                                        <div>{l s='Get label with' mod='springxbs'} <strong>{l s='Parcel Dimensions' mod='springxbs'}</strong> {l s='set below' mod='springxbs'}</div>
                                        {if $psv_1_5}
                                            <div>
                                                <label for="Parcel_dimensions_width" style="max-width: 6em !important;">{l s='width' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                                                <input class="dim-inp" id="Parcel_dimensions_width" type="number"
                                                       name="width" value="{$parcel_prefilled_dimensions['width']|floatval}">
                                            </div>
                                            <div>
                                                <label for="Parcel_dimensions_height" style="max-width: 6em !important;">{l s='height' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                                                <input class="dim-inp" id="Parcel_dimensions_height" type="number"
                                                       name="height" value="{$parcel_prefilled_dimensions['height']|floatval}">
                                            </div>
                                            <div>
                                                <label for="Parcel_dimensions_length" style="max-width: 6em !important;">{l s='depth' mod='springxbs'}, {l s='cm' mod='springxbs'}</label>
                                                <input class="dim-inp" id="Parcel_dimensions_length" type="number"
                                                       name="depth" value="{$parcel_prefilled_dimensions['depth']|floatval}">
                                            </div>
                                            <div>
                                                <label for="Parcel_dimensions_weight" style="max-width: 6em !important;">{l s='weight' mod='springxbs'}, {l s='kg' mod='springxbs'}</label>
                                                <input class="dim-inp"
                                                       id="Parcel_dimensions_weight"
                                                       type="number"
                                                       name="weight"
                                                       value="{$parcel_prefilled_dimensions['weight']|floatval}">
                                            </div>
                                            <div style="margin-top: 5px;">{l s='Customs options' mod='springxbs'}:</div>
                                            <label style="float: none; width: 100%; display: inline-block; text-align: left;padding-left: 5px;">
                                                <input type="radio"
                                                       name="ddp"
                                                       value="DDP"
                                ...
                                <div class="dimensions-container">
                                    ...
                                    <table class="dimensions">
                                        <tr>
                                            <td><span class="b">{l s='width' mod='springxbs'}</span> <br>{if $parcel_dimensions['width']}{$parcel_dimensions['width']|escape:'htmlall':'UTF-8'} {l s='cm' mod='springxbs'}{else}-{/if}</td>
                                            <td><span class="b">{l s='height' mod='springxbs'}</span> <br>{if $parcel_dimensions['height']}{$parcel_dimensions['height']|escape:'htmlall':'UTF-8'} {l s='cm' mod='springxbs'}{else}-{/if}</td>
                                            {if $psv_1_5}
                                        </tr><tr>
                                            {/if}
                                            <td><span class="b">{l s='depth' mod='springxbs'}</span> <br>{if $parcel_dimensions['depth']}{$parcel_dimensions['depth']|escape:'htmlall':'UTF-8'} {l s='cm' mod='springxbs'}{else}-{/if}</td>
                                            <td><span class="b">{l s='weight' mod='springxbs'}</span> <br>{if $parcel_dimensions['weight']}{$parcel_dimensions['weight']|escape:'htmlall':'UTF-8'} {l s='kg' mod='springxbs'}{else}-{/if}</td>
                                        </tr>
                                    </table>
                                    ...
                                    {if $parcel_dimensions['ddp'] === 'DDP'}
                                        <div style="margin-top:15px">
                                            <p>
                                                <strong>{l s='Customs Option' mod='springxbs'}:</strong> {$parcel_dimensions['ddp']|escape:'htmlall':'UTF-8'}
                                            </p>
                                            <p>
    ...
    c-266 0 -295 -2 -327 -19z"/>
                                ...
                                {if $error_level}
                                    <div style="position: relative; bottom:-30px;right:0;">
