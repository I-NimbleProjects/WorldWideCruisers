        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3 col-md-12 searchAddressButton">
                    <button type="button" name="searchAddressBtn" id="searchAddressBtn" onclick="Search();" class="btn btn-outline-dark my-0 ml-0 btn-block">{$arrtext.txtSearch|escape:'htmlall':'UTF-8'}</button>
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-lg-12">
