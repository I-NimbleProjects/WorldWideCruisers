<?php
	namespace upsWegPack;
	if(!class_exists('WeightPack')){
		include_once 'class-ups-weight-packing-util.php';
		class WeightPack{
			...
			public function __construct( $strategy, $options=array() ){
				...
				switch($strategy){
					// case 'pack_ascending':
					// 	include_once 'class-ups-weight-strategy-ascend.php';
					// 	$this->pack_obj	=	new WeightPackAscend();
					// 	break;
					// 	//case 'pack_descending':
					// case 'pack_simple':
					// 	include_once 'class-ups-weight-strategy-simple.php';
					// 	$this->pack_obj	=	new WeightPackSimple();
					// 	break;
					default:
						include_once 'class-ups-weight-strategy-descend.php';
