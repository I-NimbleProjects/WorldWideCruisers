<?php
namespace UpsEuBoxPack;
/**
 * WooCommerce Box Packer
 */
class UPS_Eu_Boxpack {
	...
	public function add_item( $length, $width, $height, $weight, $value = '', $meta = array() ) {
		$this->items[] = new UPS_Eu_Boxpack_Item( $length, $width, $height, $weight, $value, $meta );
	}
	 ...
	 * @return void
	 */
	public function add_box( $length, $width, $height, $weight = 0, $packtype = 'box' ) {

		$exclude_box_weight_from_calc = $this->exclude_box_weight;

		$new_box = new UPS_Eu_Boxpack_Box( $length, $width, $height, $packtype, $weight, $exclude_box_weight_from_calc );
		$this->boxes[] = $new_box;
		return $new_box;
	}
...
/**
 * UPS_Eu_Boxpack_Box class.
 */
class UPS_Eu_Boxpack_Box {
...
/**
 * UPS_Eu_Boxpack_Item class.
 */
class UPS_Eu_Boxpack_Item {
