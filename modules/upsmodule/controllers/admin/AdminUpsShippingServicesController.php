...
class AdminUpsShippingServicesController extends CommonController
{
    ...
    private function createFieldsValue()
    {
        ...
        $arrValueConfig = array(
            ...
            'UPS_SP_SERV_AP_SHIP_TO_ADDR'             => Configuration::get('UPS_SP_SERV_AP_SHIP_TO_ADDR'), 
    ...
    public function createFieldsForm()
    {
        ...
        if ($this->module->usa()) {
            ...
            $txtKeys['ttlAP'] = 'ttlAP';
            $txtKeys['ttlSetAPaddr'] = 'ttlSetAPaddr';
        ...
        return array(
            ...
            'input'       => array(
                ...
                array(
                    'type'   => 'switch',
                    'label'  => $this->sdk->t('shippingservice', $txtKeys['ttlSetAPaddr']),
                    'name'   => 'UPS_SP_SERV_AP_SHIP_TO_ADDR',
                    'values' => array(
                        array(
                            'id_configuration' => 'UPS_SP_SERV_AP_SHIP_TO_ADDR',
                            'value'            => 1,
                        ),
                        array(
                            'id_configuration' => 'UPS_SP_SERV_AP_SHIP_TO_ADDR',
    ...
    private function processAccessPointService()
    {
        ...
        if (Tools::getValue($toAp) == '1') {
            ...
            $this->updateValueItem('UPS_SP_SERV_AP_SHIP_TO_ADDR');
            return true;
        } else {
            return false;
        }
