...
class PosThemeoptions extends Module implements WidgetInterface
{
    ...
    public function install()
    {
		$this->createHooks();
        //General
        Configuration::updateValue($this->name . 'g_main_color', '#1abcbd');
        Configuration::updateValue($this->name . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
        Configuration::updateValue($this->name . 'g_body_gfont_name', '"Poppins", sans-serif');
        ...
        // Configuration::updateValue($this->name . 'g_a_colorh', '#1abcbd');
        Configuration::updateValue($this->name . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap'); 
        Configuration::updateValue($this->name . 'g_title_gfont_name', '"Poppins", sans-serif');
        Configuration::updateValue($this->name . 'g_title_font_size', 36);
        Configuration::updateValue($this->name . 'g_title_font_color', '#454545');
        Configuration::updateValue($this->name . 'g_title_font_transform', 3);
        Configuration::updateValue($this->name . 'g_title_font_size_column', 32);
        ...
        // Configuration::updateValue($this->name . 'g_button_bgcolorh', '#1abcbd');
        ...
        // Configuration::updateValue($this->name . 'g_footer_a_colorh', '#1abcbd');
        // Product
        Configuration::updateValue($this->name . 'p_display', 1);
        Configuration::updateValue($this->name . 'p_name_color', '#454545');
        Configuration::updateValue($this->name . 'p_name_colorh', '#1abcbd');
        ...
        Configuration::updateValue($this->name . 'p_price_color', '#1abcbd');
        ...
        Configuration::updateValue($this->name . 'pp_name_color', '#454545');
        Configuration::updateValue($this->name . 'pp_name_size', 24);
        Configuration::updateValue($this->name . 'pp_name_transform', 2);
        Configuration::updateValue($this->name . 'pp_price_color', '#454545');
    ...
    public function generateCss()
    {
		...
		$css .='
           a:hover,
			...
			.block_setting .icon-Settings:hover,
			...
			.static-three-air .box .col.col-text .inner .price,
			.static-three-air .box .col.col-text .inner h3 span,
			.static-one-vacuum .box .col.col-text .inner h3 span,
			.static-one-smart .col-text .inner h3 span,
		...
		.static-three-air .box .col.col-text .inner a:hover,
		...
		.static-one-vacuum .box .col.col-text .inner a,
		.static-two-vacuum .txt_cms a,
		.static-two-smart .col-text a,
		.pos_title:before,
		.pos_title:after,
		.owl-nav > div:hover,
        ...
        $css .='.pos_title h2{ 
		 ...
		 $css .='#_desktop_contact_link .contact-link a,.desc_slideshow h2,.desc_slideshow h3,.desc_slideshow h4,.banner-box .txt_cms h3,
