...
class AdminUpsAccountSuccessController extends CommonController
{
    ...
    public function initContent()
    {
        ...
        $texts = array(
            ...
            'txtAccAddUsernameandPwd'  => $this->sdk->t('account', 'txtAccAddUsernameandPwd'),
            ...
            'txtUPSUsername'           => $this->sdk->t('account', 'txtUPSUsername'),
            'txtUPSPassword'           => $this->sdk->t('account', 'txtUPSPassword'),
            ...
            'txtProceedChange'         => $this->sdk->t('account', 'txtProceedChange'),
            ...
            'txtTTUPSUsername'         => $this->sdk->t('account', 'txtTTUPSUsername'),
            'txtTTUPSPassword'         => $this->sdk->t('account', 'txtTTUPSPassword'),
        ...
        if (static::$checkError == 1) {
            $varTpl = array(
                ...
                'UPSUsername'    => Tools::getValue('UPSUsername'),
                'UPSPassword'    => Tools::getValue('UPSPassword'),
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('SubmitUsernameandPwd')) {
            $UPSUsername = Tools::getvalue('UPSUsername');
            $UPSPassword = Tools::getvalue('UPSPassword');
           
           if (isset($UPSUsername) && !empty($UPSUsername) && isset($UPSPassword) && !empty($UPSPassword)) {
                 Configuration::updateValue('MY_UPS_ID', $UPSUsername); 
                 Configuration::updateValue('UPS_PASS',  $UPSPassword);
           } elseif (isset($UPSUsername) && !empty($UPSUsername)) {
                 Configuration::updateValue('MY_UPS_ID', $UPSUsername); 
           } elseif (isset($UPSPassword) && !empty($UPSPassword)) { 
                 Configuration::updateValue('UPS_PASS',  $UPSPassword);
           }
        }
