...
class AdminUpsAccountController extends CommonController
{
    ...
    public function initContent()
    {
        ...
        $varTpl = array(
            ...
            'txtUPSUsername'           => $sdk->t('account', 'txtUPSUsername'),
            'txtUPSPassword'           => $sdk->t('account', 'txtUPSPassword'),
            ...
            'txtHaveAccIDandPwd'       => $sdk->t('account', 'txtHaveAccIDandPwd'),
            'txtGetStarted'            => $sdk->t('account', 'title'),
            'txtTTAccountNumber'       => $sdk->t('account', 'txtTTAccountNumber'),
            'txtAccTTUsrID'            => $sdk->t('account', 'txtAccTTUsrID'),
            'txtAccTTPwd'              => $sdk->t('account', 'txtAccTTPwd'),
            'txtAccTTAcssKey'          => $sdk->t('account', 'txtAccTTAcssKey'),
            ...
            'txtaccnme'                => $sdk->t('account', 'txtaccnme'),
            'txtaccno'                 => $sdk->t('account', 'txtaccno'),
            'txtusrid'                 => $sdk->t('account', 'txtusrid'),
            'txtpwd'                   => $sdk->t('account', 'txtpwd'),
            'txtacsskey'               => $sdk->t('account', 'txtacsskey'),
            'txtAccTTAddressType'      => $sdk->t('account', 'txtAccTTAddressType'),
            'txtPleaseNote'            => $sdk->t('account', 'txtPleaseNote'),
            'txtAcssKeyNote1'           => $sdk->t('account', 'txtAcssKeyNote1'),
            'txtAcssKeyNote2'           => $sdk->t('account', 'txtAcssKeyNote2'),
            ...
            'txtAcssKeyLink' => $this->links['acsskey'],
        ...
        if (static::$hasErr == 1) {
            ...
            $varTpl['accnme']         = Tools::getValue('accnme');
            $varTpl['accno']         = Tools::getValue('accno');
            $varTpl['UsrID']          = Tools::getValue('UsrID');
            $varTpl['Pwd']            = Tools::getValue('Pwd');
            $varTpl['AcssKey']       = Tools::getValue('AcssKey');
