...
<script language="JavaScript" type="text/javascript">
    ...
    var urlChangeShippingService = '{$link->getPageLink('eshoper&fc=module&module=upsmodule&ajax=1&action=ChangeShippingService')|escape:'javascript':'UTF-8'}';
    var urlSelectAccessPoint = '{$link->getPageLink('eshoper&fc=module&module=upsmodule&ajax=1&action=SelectAccessPoint')|escape:'javascript':'UTF-8'}';
    var urlSearchAccessPoint = '{$link->getPageLink('eshoper&fc=module&module=upsmodule&ajax=1&action=SearchAccessPoint')|escape:'javascript':'UTF-8'}';
</script>
{* <!-- begin collapse --> *}
<div id="accordion" class="width100">
