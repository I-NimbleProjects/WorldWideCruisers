...
if ($_SERVER['HTTP_HOST'] != 'ps.hitactivity.com') {
    // PRODUCTION
...
$mapping = array(
    ...
    'PluginManager\CollectionApi\DefaultPackageRate' => __DIR__ . '/PluginManager/CollectionApi/DefaultPackageRate.php',
    ...
    'Bean\PackageDimension' => __DIR__ . '/beans/PackageDimension.php',
