...
class Shipping extends CommonHandle
{
    ...
    protected function responseHandler($response)
    {
        ...
        } elseif (isset($data->Fault) || !isset($data->ShipmentResponse) || empty($data->ShipmentResponse)) {
            return [
    ...
    private function publishedRateShipment($args)
    {
        ...
        $shipmentServices = $this->shipmentServiceOptionsHandle($args['accessorialsService'], $order, $countryCodeData, '', $shiptoCountry);
