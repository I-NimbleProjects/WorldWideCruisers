        ...
        <div class="panel">
            ...
            <div class="form-wrapper">
                <div class="form-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table style="width:100%; background-color: #EDF7FB;">    
                                <tr>
                                    <th style="text-align:center; color:#000000;  padding: 15px;">STEP 1:  ACCOUNT LINKING</th>   
                                </tr>
                            </table>
                        </div>
                    </div><br/>
                    ...
                    <div class="container">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="optradio" checked id="rate09" value="3">{$txtHaveAccIDandPwd|escape:'htmlall':'UTF-8'}
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="rate09_show">
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">
                                                        <span href="" data-toggle="tooltip" class="label-tooltip" title="{$txtAccTTAccountName|escape:'htmlall':'UTF-8'}" data-placement="top" data-html="true">{$txtaccnme|escape:'htmlall':'UTF-8'}:<sup class="star">*</sup></span>
                                                    </label>
                                                    <div class="col-lg-9">
                                                        <input type="text" id="accnme" name="accnme" value="{$accnme|escape:'htmlall':'UTF-8'}" maxlength="35" class="form-control ups-form-control fixed-width-xxl">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">
                                                        <span href="" data-toggle="tooltip" class="label-tooltip" title="{$txtTTAccountNumber|escape:'htmlall':'UTF-8'}" data-placement="top" data-html="true">{$txtaccno|escape:'htmlall':'UTF-8'}:<sup class="star">*</sup></span>
                                                    </label>
                                                    <div class="col-lg-9">
                                                        <input type="text" id="accno" name="accno" value="{$accno|escape:'htmlall':'UTF-8'}" maxlength="6" class="form-control ups-form-control fixed-width-xxl">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">
                                                        <span href="" data-toggle="tooltip" class="label-tooltip" title="{$txtAccTTUsrID|escape:'htmlall':'UTF-8'}" data-placement="top" data-html="true">{$txtusrid|escape:'htmlall':'UTF-8'}<sup class="star">*</sup></span>
                                                    </label>
                                                    <div class="col-lg-9">
                                                        <input type="text" id="UsrID" name="UsrID" value="{$UsrID|escape:'htmlall':'UTF-8'}" maxlength="35" class="form-control ups-form-control fixed-width-xxl">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">
                                                        <span href="" data-toggle="tooltip" class="label-tooltip" title="{$txtAccTTPwd|escape:'htmlall':'UTF-8'}" data-placement="top" data-html="true">{$txtpwd|escape:'htmlall':'UTF-8'}<sup class="star">*</sup></span>
                                                    </label>
                                                    <div class="col-lg-9">
                                                        <input type="text" id="Pwd" name="Pwd" value="{$Pwd|escape:'htmlall':'UTF-8'}" maxlength="35" class="form-control ups-form-control fixed-width-xxl">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">
                                                        <span href="" data-toggle="tooltip" class="label-tooltip" title="{$txtAccTTAcssKey|escape:'htmlall':'UTF-8'}" data-placement="top" data-html="true">{$txtacsskey|escape:'htmlall':'UTF-8'}<sup class="star">*</sup></span>
                                                    </label>
                                                    <div class="col-lg-9">
                                                        <input type="text" id="AcssKey" name="AcssKey" value="{$AcssKey|escape:'htmlall':'UTF-8'}" maxlength="35" class="form-control ups-form-control fixed-width-xxl"><br/>
                                                    </div>
                                                    <div class="clearfix"></div>    
                                                </div>
                                            </div>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <br/><br/>
                                                    <h2> USEFUL INFO</h2>
                                                    <label class="col-lg-7">{$txtAcssKeyNote1|escape:'htmlall':'UTF-8'}</label><br/>
                                                    <label class="col-lg-7">{$txtAcssKeyNote2|escape:'htmlall':'UTF-8'}
                                                        <a target='_blank' href="{$txtAcssKeyLink|escape:'htmlall':'UTF-8'|htmlspecialchars_decode:3}">[{$txtAcssKeyLink|escape:'htmlall':'UTF-8'|htmlspecialchars_decode:3}]
                                                        </a>
                                                    </label><br/>
                                                </div>
                                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" id="rate06" value="0">{$txtHaveNoAccount|escape:'htmlall':'UTF-8'}
                                        {if $isUSA}
                        ...
                        <div class="rate06_show upshidden">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="container">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                ...
                                                                <div>
                                                                    <label class="col-lg-12">{$txtInformationDangerous|escape:'htmlall':'UTF-8'|htmlspecialchars_decode:3}<br/>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table style="width:100%; background-color: #EDF7FB;">
                                <tr>
                                    <th style="text-align:center; color:#000000;  padding: 15px;">STEP 2: MERCHANT AND PICKUP ADDRESS</th>
                                </tr>
                            </table>
                        </div>
                    </div><br/>
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio"  id="rate05" value="2">{$txtHaveAccountUPSWithout|escape:'htmlall':'UTF-8'}
                                </label>
                            </div>
                        </div>
