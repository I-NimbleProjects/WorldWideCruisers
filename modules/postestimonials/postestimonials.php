   ...
   public function __construct()
    ...
    public function uninstall()
    {
        ...
        Db::getInstance()->execute('
            ...
            INSERT INTO `'._DB_PREFIX_.'postestimonial` (`id_postestimonial`,`email`,`media`,`media_type`,`active`,`position`)  VALUES ("4","demo@posthemes.com","sample4.png","png","1","4");
            INSERT INTO `'._DB_PREFIX_.'postestimonial` (`id_postestimonial`,`email`,`media`,`media_type`,`active`,`position`)  VALUES ("5","demo@posthemes.com","sample5.png","png","1","5");
            INSERT INTO `'._DB_PREFIX_.'postestimonial` (`id_postestimonial`,`email`,`media`,`media_type`,`active`,`position`)  VALUES ("6","demo@posthemes.com","sample6.png","png","1","6")');
        foreach($languages as $lang){
            Db::getInstance()->execute('
                ...
                INSERT INTO `'._DB_PREFIX_.'postestimonial_lang` (`id_postestimonial`,`id_lang`,`name_post`,`address`,`content`)  VALUES ("2",'.$lang['id_lang'].',"orando BLoom"," No 40 Baria Sreet 133/2, NewYork, USA.","Perfect Themes and the best of all that you have many options to choose! Best Support team ever!Very fast responding and experts on their fields! Thank you very much!");
                INSERT INTO `'._DB_PREFIX_.'postestimonial_lang` (`id_postestimonial`,`id_lang`,`name_post`,`address`,`content`)  VALUES ("3",'.$lang['id_lang'].',"orando BLoom"," No 40 Baria Sreet 133/2, NewYork, USA.","Code, template and others are very good. The support has served me immediately and solved my problems when I need help. Are to be congratulated. Att Renan Andrade");
                INSERT INTO `'._DB_PREFIX_.'postestimonial_lang` (`id_postestimonial`,`id_lang`,`name_post`,`address`,`content`)  VALUES ("4",'.$lang['id_lang'].',"orando BLoom"," No 40 Baria Sreet 133/2, NewYork, USA.","Perfect Themes and the best of all that you have many options to choose! Best Support team ever!Very fast responding and experts on their fields! Thank you very much!");
                INSERT INTO `'._DB_PREFIX_.'postestimonial_lang` (`id_postestimonial`,`id_lang`,`name_post`,`address`,`content`)  VALUES ("5",'.$lang['id_lang'].',"orando BLoom"," No 40 Baria Sreet 133/2, NewYork, USA.","Perfect Themes and the best of all that you have many options to choose! Best Support team ever!Very fast responding and experts on their fields! Thank you very much!");
                INSERT INTO `'._DB_PREFIX_.'postestimonial_lang` (`id_postestimonial`,`id_lang`,`name_post`,`address`,`content`)  VALUES ("6",'.$lang['id_lang'].',"orando BLoom"," No 40 Baria Sreet 133/2, NewYork, USA.","Code, template and others are very good. The support has served me immediately and solved my problems when I need help. Are to be congratulated. Att Renan Andrade")');
        ...
        Db::getInstance()->execute('
            ...
            INSERT INTO `'._DB_PREFIX_.'postestimonial_shop` (`id_postestimonial`,`id_shop`)  VALUES ("4","1");
            INSERT INTO `'._DB_PREFIX_.'postestimonial_shop` (`id_postestimonial`,`id_shop`)  VALUES ("5","1");
            INSERT INTO `'._DB_PREFIX_.'postestimonial_shop` (`id_postestimonial`,`id_shop`)  VALUES ("6","1")');
    }
